...
export default function ValueCard({ id, title, desc }: Props) {
  return (
    <div className="group flex h-full flex-col items-start rounded-2xl border border-line bg-white p-7 transition-[transform,box-shadow] duration-500 hover:-translate-y-1 hover:shadow-card">
